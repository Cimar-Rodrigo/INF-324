    ...
    public partial class Form1 : Form
    {
        ...
        private async Task ObtenerDatos()
        {
            try {
                ...
                {
                    HttpResponseMessage resPersona = await cliente.GetAsync("http://localhost/Examen324/Ejercicio4/api1.php");
                    HttpResponseMessage resCuenta = await cliente.GetAsync("http://localhost/Examen324/Ejercicio4/api2.php");
